package be.swsb.typesafety.example2.external.legacybookingsystem.acl;
...
import be.swsb.typesafety.example2.external.legacybookingsystem.acl.mapper.LegacyMapper;
...
import be.swsb.typesafety.example2.external.legacybookingsystem.acl.types.LegacyBookingTypeTestBuilder;
import be.swsb.typesafety.example2.external.legacybookingsystem.acl.client.LegacyClient;
...
class LegacyBookingServiceTest extends UnitTest {
    ...
    void createBookingRecord_SendsAllBookingsAsXml() {
        ...
        final Booking bookingToBeSent1 = BookingTestBuilder.defaultBooking().withBookingCode("9786sdf").build();
        final Booking bookingToBeSent2 = BookingTestBuilder.defaultBooking().withBookingCode("978iasudf80ufda").build();
