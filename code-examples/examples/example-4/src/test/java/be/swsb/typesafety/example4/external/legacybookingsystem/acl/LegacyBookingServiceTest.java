...
import be.swsb.typesafety.example4.domain.booking.BookingCodeForTests;
...
import be.swsb.typesafety.example4.external.legacybookingsystem.acl.types.LegacyBookingTypeTestBuilder;
